...
try {
    ...
    $mail->Subject = 'Your Request (Ticket ID: '.$data[0]['ticketID'].') is completed!';

    // Set email body as HTML
    $mail->isHTML(true);
    $body = 'Greetings, '.$data[0]['clientName'].'!<br><br>Your certificate request (Ticket ID: '.$data[0]['ticketID'].') has been processed! You can download your certificate/s at this address below:<br><br>https://web-gnis.42web.io/certTrack.php<br>https://web-gnis.42web.io/certTrack.php<br>https://web-gnis.42web.io/certTrack.php<br><br>Use your credentials below to access the file.<br><br>Ticket ID: <b>'.$data[0]['ticketID'].'</b><br>Email Address: <b>'.$data[0]['emailAdd'].'</b><br><br>Thank you for availing our services!<br><br>Ensuring accuracy and precision,<br><b>WebGNIS Service Team</b>';
    $mail->Body = $body;
