...
try {
    switch ($mainEndpoint) {
        ...
        case 'update':
            ...
            if (!$token || ($token->user_type !== 'admin' && $token->user_type !== 'moderator')) {
                returnResponse(401, "Unauthorized access. Only admins and moderators can update transaction status.", null);
            }
