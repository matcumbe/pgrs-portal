...
CREATE TABLE users (
    ...
    user_type ENUM('individual', 'company', 'moderator', 'admin') NOT NULL,
    sex_id INT,
...
INSERT INTO users (username, password, email, contact_number, user_type, is_active)
VALUES ('moderator', '$2y$10$hnGYVtK1mzGMKyhVsFLZbeAXbLiGCnbnuzuV6Dj7uSPa6oHwdcE7C', 'moderator@webgnis.gov.ph', '09123456788', 'moderator', TRUE);
-- Password is 'admin123' hashed with bcrypt
