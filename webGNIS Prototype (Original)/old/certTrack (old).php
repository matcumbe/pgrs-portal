...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_completed = "SELECT * FROM completed_request WHERE ID = '$requestId' AND email = '$email'";
    ...
    if ($result_completed->num_rows > 0) {
        ...
        $certificateFileName = $row['ID'] . ".pdf";
        ...
        $sql_pending = "SELECT * FROM gcp_request WHERE ID = '$requestId' AND email = '$email'";
