...
function getStationDetails(statName) {
    ...
    xhttp.open("GET", "management_c_getstationdetails.php?stat_name=" + statName, false);
    xhttp.send();
    return stations;
}
...
function fetchUpdatedData() {
    ...
    xhttp.open("GET", "management_c_fetchrequests.php", true);
    xhttp.send();
}
...
function generatePDF(clientName, ticketID, emailAdd, button) {
    ...
    if (selectedRequest) {
        ...
        xhttp.open("POST", "management_c_generatePDF.php", true);
