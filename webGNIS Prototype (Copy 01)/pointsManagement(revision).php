...
.dropdown:hover .dropdown-content {
    display: block;
        ...
        .table-container {
            ...
            max-height: 91%; /* Adjusted maximum height to account for header and padding */
        }
        table {
            width: 100%;
...
<body>
    ...
    <form>
        ...
        <div class="input-group">
            ...
            <label for="lastEdit">Date of Last Edit:</label>
            <input type="text" id="lastEdit" name="lastEdit" disabled>
            <label for="encoder">Encoder:</label>
            <input type="text" id="encoder" name="encoder" disabled>
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            if (data.error) {
                ...
                //document.getElementById('lastEdit').value = data.dataLastEdit;
                //document.getElementById('encoder').value = data.encoder;
...
function addRow() {
    ...
    document.getElementById("lastEdit").disabled = true;*/
}
