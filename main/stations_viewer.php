        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav mx-auto">
                    ...
                    <a class="nav-link admin-only active" href="stations_viewer.php"><i class="fas fa-table"></i> Stations Viewer</a>
                    <a class="nav-link admin-only" href="requests_management.php"><i class="fas fa-tasks"></i> Requests Management</a>
                    <a class="nav-link admin-only" href="users_management.php"><i class="fas fa-users"></i> Users Management</a>
