      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="stationTypeModalLabel">Select Station Type</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <p>For this horizontal station, please specify if it's a Regular or CAAP station.</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" id="modalRegularButton">Regular</button>
            <button type="button" class="btn btn-success" id="modalCaapButton">CAAP</button>
          </div>
        </div>
      </div>
    </div>
